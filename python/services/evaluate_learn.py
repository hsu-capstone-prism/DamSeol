...
def evaluate_sentence(eval_texts):
  ...
  예제:
    {
      "pronunciation": 5,  # 발음 정확도에 대한 1~5점 사이의 정량적 점수
      "pitch": 4,  # 음성의 피치에 대한 1~5점 사이의 정량적 점수
      "rhythm": 3,  # 음성의 리듬에 대한 1~5점 사이의 정량적 점수
      "advice": "발음: 'ㄱ' 발음을 'ㅂ' 발음과 혼동하고 있어요. 'ㄱ'과 'ㅂ'의 발음 원리에 대해 다시 학습해보세요. 😊
