...
INSERT INTO game_scenario (video_file_name, situation) VALUES
    ('friend', '친구가 갑자기 심각한 표정으로 이야기합니다.'), ('mart', '마트에서 계산원이 말합니다.'), ('hospital', '의사가 청진기를 대며 조심스럽게 말합니다.'),
    ('company', '팀장이 회의에서 자료를 보여주며 말합니다.'), ('school', '선생님이 칠판을 가리키며 말합니다.'), ('mart2', '마트에서 계산원이 말합니다.'),
    ('restaurant', '주문을 마친 당신에게 직원이 다시 묻습니다.'), ('mart3', '마트에서 계산원이 말합니다.'), ('hospital2', '진료실에서 의사가 당신의 검사 결과를 보며 말합니다.'),
    ('company2', '팀장이 회의에서 자료를 보여주며 말합니다.'), ('mart4', '마트에서 계산원이 말합니다.'), ('mart5', '마트에서 계산원이 말합니다.'),
    ('restaurant2', '주문을 마친 당신에게 직원이 다시 묻습니다.'), ('restaurant3', '직원이 메뉴판을 건네며 설명합니다.'), ('restaurant4', '주문을 마친 당신에게 직원이 다시 묻습니다.'),
    ('friend2', '친구가 갑자기 심각한 표정으로 이야기합니다.'), ('school2', '학생이 수업 후 질문을 하자 선생님이 답합니다.'), ('school3', '학생이 수업 후 질문을 하자 선생님이 답합니다.'),
    ('mart6', '마트에서 계산원이 말합니다.'), ('mart7', '마트에서 계산원이 말합니다.');
...
INSERT INTO gamescenario_choices (scenario_id, text, is_correct) VALUES
    ...
    (2, '영수증 드릴까요?', true), (2, '비닐봉투는 필요하신가요?', false), (2, '포인트 적립하시겠어요?', false),
    (3, '폐에 약간의 염증이 보입니다.', false), (3, '혈압이 다소 낮습니다.', true), (3, '심장 박동이 불규칙합니다.', false),
    (4, '예산은 다음 주에 확정됩니다.', true), (4, '이번 프로젝트는 일정이 촉박합니다.', false), (4, '디자인 시안은 다시 검토해보세요.', false),
    (5, '이 공식을 꼭 외우세요.', false), (5, '조별 과제는 두 명씩 진행합니다.', true), (5, '다음 시험은 다음 주입니다.', false),
    (6, '비닐봉투는 필요하신가요?', false), (6, '영수증 드릴까요?', true), (6, '포인트 적립하시겠어요?', false),
    (7, '후식도 준비해드릴까요?', false), (7, '계산은 선불입니다.', false), (7, '물은 필요하지 않으신가요?', true),
    (8, '포인트 적립하시겠어요?', false), (8, '비닐봉투는 필요하신가요?', true), (8, '영수증 드릴까요?', false),
    (9, '척추가 많이 휘어있습니다.', false), (9, '척추를 한번 살펴보았습니다.', false), (9, '이게 환자분의 척추입니다.', true),
    (10, '예산은 다음 주에 확정됩니다.', false), (10, '디자인 시안은 다시 검토해보세요.', false), (10, '이번 프로젝트는 일정이 촉박합니다.', true),

    (11, '영수증 드릴까요?', false), (11, '포인트 적립하시겠어요?', true), (11, '비닐봉투는 필요하신가요?', false),
    (12, '포인트 적립하시겠어요?', false), (12, '영수증 드릴까요?', false), (12, '비닐봉투는 필요하신가요?', true),
    (13, '물은 필요하지 않으신가요?', false), (13, '후식도 준비해드릴까요?', true), (13, '계산은 선불입니다.', false),
    (14, '이건 셰프가 직접 만든 디저트입니다.', false), (14, '이 요리는 매운맛이 강합니다.', false), (14, '이 메뉴는 오늘의 추천 요리입니다.', true),
    (15, '물은 필요하지 않으신가요?', false), (15, '계산은 선불입니다.', false), (15, '후식도 준비해드릴까요?', true),
    (16, '나 할 말이 있어.', true), (16, '조금 있다가 다시 말할게.', false), (16, '그 얘긴 지금 하기 어려워.', false),
    (17, '그건 다음 시간에 다시 설명할게요.', false), (17, '질문해줘서 고마워요.', true), (17, '그 부분은 교과서 45쪽에 있어요.', false),
    (18, '그 부분은 교과서 45쪽에 있어요.', false), (18, '그건 다음 시간에 다시 설명할게요.', true), (18, '질문해줘서 고마워요.', false),
    (19, '포인트 적립하시겠어요?', false), (19, '비닐봉투는 필요하신가요?', true), (19, '영수증 드릴까요?', false),
    (20, '영수증 드릴까요?', false), (20, '비닐봉투는 필요하신가요?', false), (20, '포인트 적립하시겠어요?', true);